...
<body>
   ...
   %>
		  ...
		  <div class="col-sm-12 col-md-8">
			<div class="row">
				<table align="center">
					...
					<tr>
						<td align="center"><span style="font-size:22px; color: red">(by Best User)</span></td>
					</tr>
            	</table>			
				</div>
				</div>
	...
	<footer class="bg-191 color-ccc">
			...
			<p class="color-ash">
				Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ion-heart" aria-hidden="true"></i> by <a href="#" target="_blank">B-Ride on Blockchain</a>
			</p><br>
			</div>
	</footer>
